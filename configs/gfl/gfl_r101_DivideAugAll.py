...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file= base+'Coco_File/TrainDivide.json',
        img_prefix= base,
        classes=classes,
    ...
    val=dict(
        type=dataset_type,
        ann_file= base+'Coco_File/TestDivide.json',
        img_prefix= base,
        classes=classes,
...
load_from = 'pretrained_models/gfl_r101_fpn_mstrain_2x_coco_20200629_200126-dd12f847.pth'
# resume_from = 'work_dirs/gfl_r101_CellNucAugAll/latest.pth'
